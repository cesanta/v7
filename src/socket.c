...
static struct socket_internal *check_and_get_si(struct v7 *v7, val_t this_obj) {
...
static void compose_sockaddr(struct v7 *v7, struct socket_internal *si,
                             struct sockaddr *sa) {
  ...
  switch (si->family) {
    ...
    default:
      throw_exception(v7, INTERNAL_ERROR, "Unsupported address family");
  }
}
...
static v7_val_t Socket_bind(struct v7 *v7, val_t this_obj, val_t args) {
  ...
  struct socket_internal *si = check_and_get_si(v7, this_obj);
...
V7_PRIVATE void init_socket(struct v7 *v7) {
  ...
  {
    v7_val_t family = v7_create_object(v7);
  ...
  {
    v7_val_t type = v7_create_object(v7);
  ...
  {
    v7_val_t recvtype = v7_create_object(v7);
